...
// component
import LoginSvg from '@/components/assets/login-svg'

const Login = () => {
  return (
    <div className=' w-full h-[100vh] flex justify-center items-center '>
      <div className='rounded-lg border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark mx-4'>
        <div className='grid grid-cols-12 items-center'>
          <div className='hidden md:flex justify-center items-center col-span-5 px-5'>
            <span className=' inline-block'>
              <LoginSvg />
            </span>
          </div>

          <div className='md:col-span-7 col-span-12 w-full border-stroke dark:border-strokedark  xl:border-l-2'>
            <div className='md:w-full xsm:w-[420px] p-4 sm:p-12.5 xl:p-13'>
